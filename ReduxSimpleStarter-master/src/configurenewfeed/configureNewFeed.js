    ...
    constructor(props) {
        ...
        this.state = {
            ...
            errors: {
                ...
                failureToleranceRangeError: '1 to 100'
            },
            feedDetails: {
                feedId: '',
                feedName: '',
                ...
                <Form>
                    ...
                    <div className="feedForm">
                        ...
                        <Row>
                            ...
                            <Col sm={4}>
                                <input className="boxBorder" name="feedId" value={this.state.feedDetails.feedId}
                                       onChange={this.updateState} type="number"/>
                                {this.checkFieldValidation('feedId')}
                            </Col>
                            <Col sm={3}>
                                <label className="fontweightClass">Feed Name:</label>
                            </Col>
                            <Col sm={3}>
                                <input className="boxBorder" name="feedName"
                                       value={this.state.feedDetails.feedName} onChange={this.updateState} type="text"/>
                                {this.checkFieldValidation('feedName')}
                            </Col>
                        </Row>
                        ...
                        <Row>
                            ...
                            <Col sm={3}>
                                <input className="boxBorder" type="text" name="vendorSrcDataPoint"
                                       value={this.state.feedDetails.vendorSrcDataPoint} onChange={this.updateState}/>
                                {this.checkFieldValidation('vendorSrcDataPoint')}
                        ...
                        <Row>
                            ...
                            <Col sm={4}>
                                <select className="boxBorder" name="feedFrequency"
                                ...
                                {this.checkFieldValidation('feedFrequency')}
                            </Col>
                            <Col sm={3}>
                                <label className="fontweightClass">File Format:</label>
                            </Col>
                            <Col sm={3}>
                                <select className="boxBorder" name="fileFormat"
                                ...
                                {this.checkFieldValidation('fileFormat')}
                        ...
                        <Row>
                            ...
                            <Col sm={4}>
                                <input className="boxBorder" type="number" name="retentionPeriod"
                                       value={this.state.feedDetails.retentionPeriod} onChange={this.updateState}/>
                                {this.checkFieldValidation('retentionPeriod')}
                            </Col>
                            <Col sm={3}>
                        ...
                        <Row>
                            ...
                            <Col sm={4}>
                                <select className="boxBorder" name="loadingMode"
                                ...
                                {this.checkFieldValidation('loadingMode')}
                        ...
                        <Row>
                            ...
                            <Col sm={4}>
                                <input className="boxBorder" type="text" name="tableNameCredentials"
                                       value={this.state.feedDetails.tableNameCredentials} onChange={this.updateState}/>
                                {this.checkFieldValidation('tableNameCredentials')}
                            </Col>
                            <Col sm={3}>
                        ...
                        <Row>
                            ...
                            <Col sm={3}>
                                <input className="boxBorder" type="text" name="feedNotificationSubscription"
                                       value={this.state.feedDetails.feedNotificationSubscription}
                                       onChange={this.updateState}/>
                                {this.checkFieldValidation('feedNotificationSubscription')}
                        ...
                        <Row>
                            ...
                            <Col sm={4}>
                                <input className="boxBorder" type="text" name="dataControl"
                                       value={this.state.feedDetails.dataControl} onChange={this.updateState}/>
                                {this.checkFieldValidation('dataControl')}
                            </Col>
                            <Col sm={3}>
                    ...
                    <Input type="button" onClick={this.saveFeedDetails.bind(this)} value="SAVE"
                           className="buttonStyle marginDetails boxBorder indexColor fontweightClass colorFileDetails"></Input>
